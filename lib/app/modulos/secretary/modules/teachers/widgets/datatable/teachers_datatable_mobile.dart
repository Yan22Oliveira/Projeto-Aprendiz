...
class TeachersDataTableMobile extends StatefulWidget {

  final List<TeacherModel> listTeachers;
  const TeachersDataTableMobile({
    required this.listTeachers,
    Key? key,
  }) : super(key: key);

  @override
  State<TeachersDataTableMobile> createState() => _TeachersDataTableMobileState();
}

class _TeachersDataTableMobileState extends State<TeachersDataTableMobile> {
