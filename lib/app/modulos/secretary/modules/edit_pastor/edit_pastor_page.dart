...
class EditPastorPage extends StatefulWidget {

  final PastorModel shepherd;
  ...
  @override
  State<EditPastorPage> createState() => _EditPastorPageState();
}

class _EditPastorPageState extends State<EditPastorPage> {
